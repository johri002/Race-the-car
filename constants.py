...
# Importing images
carImg = pygame.image.load("img/car_11.png")
carImg1 = pygame.image.load("img/car_22.png")
flagImg = pygame.image.load("img/blue2.jpg")
flagImg1 = pygame.image.load("img/red2.jpg")
hmImg1 = pygame.image.load("img/hm2.jpg")

# The maximum number of fences a player can use
FENCELIMIT = 8  
